...
def process_audio_extraction(
    ...
    original_filename = build_audio_filename(
        skip_segments=skip_segments, instrumental=False)
    original_file_path = build_audio_output_path(
        video_id, filename=original_filename)

    instrumental_filename = build_audio_filename(
        skip_segments=skip_segments, instrumental=True)
    instrumental_file_path = build_audio_output_path(
        video_id, filename=instrumental_filename)
